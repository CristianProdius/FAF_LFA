...
class FiniteAutomaton:
    ...
    def draw(self):
        ...
        # Create a new graph without multiedges for the edge labels
        G_labels = nx.DiGraph()
        for (state, input_symbol, next_state) in self.delta:
            if not G_labels.has_edge(state, next_state):
                G_labels.add_edge(state, next_state, label=input_symbol)
        ...
        edge_labels = nx.get_edge_attributes(G_labels, 'label')
        nx.draw_networkx_edge_labels(G_labels, pos, edge_labels=edge_labels)
        plt.show()
...
finite_automaton = FiniteAutomaton()
finite_automaton.Q = {'q0', 'q1', 'q2', 'q3'}  # Set of states
finite_automaton.Sigma = {'a', 'b', 'c'}  # Input alphabet
finite_automaton.delta = {('q0', 'a', 'q0'), ('q0', 'a', 'q1'), ('q1', 'b', 'q2'), 
                          ('q2', 'c', 'q3'), ('q3', 'c', 'q3'), ('q2', 'a', 'q2')}  # Transitions
finite_automaton.q0 = 'q0'  # Initial state
finite_automaton.F = {'q3'}  # Set of accepting states
