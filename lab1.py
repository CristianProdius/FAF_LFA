...
# Define the grammar rules for Variant 21
VN = {"S", "B", "C", "D"}
VT = {"a", "b", "c"}
0
P = {
...
# Create an instance of the Grammar class for Variant 21
grammar_variant_21 = Grammar(VN, VT, P)

# Generate 5 valid strings
print("Generated strings:")
for _ in range(5):
    generated_string = grammar_variant_21.generate_string("S")
...
# Test strings
test_strings = ["ab", "aba", "abba", "abab", "abcb"]
print("\nTesting strings:")
for string in test_strings:
    fa = grammar_to_finite_automaton(grammar_variant_21)
